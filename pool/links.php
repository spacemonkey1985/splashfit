...
<title>Splash Fit - The Pool</title>
    	...
    	<div class="header-content">
            ...
            <div class="tabs">
            	<ul>
                    ...
                    <li><a href="pool.htm">THE POOL</a></li>
    	...
    	<div class="columns">
        	<div style="width: 420px; position: absolute; left: 60px; top: 10px;">
            	<div style="position: absolute; left: -60px; top: 0px; z-index: -1;">
                	<img src="images/Pool-Logo-Faded.png" alt="Gym Logo" />
                </div>
            	<h2>Links</h2>
                <ul>
                	<li><a href="http://www.splashfit.co.uk">Splash Fit</a></li>
                    <li><a href="http://gym.splashfit.co.uk">Splash Fit Gym</a></li>
                    <li><a href="http://pool.splashfit.co.uk">Splash Fit Pool</a></li>
                    <li><a href="http://www.tlctherapies.org">TLC Therapies</a></li>
                    <li><a href="http://www.derbytkd.co.uk">Derby School of Tae Kwon-Do</a></li>
                </ul>
            </div>
