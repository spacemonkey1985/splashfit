    ...
    <div class="content">
    	<div class="columns">
        	<div style="width: 420px; position: absolute; left: 60px; top: 10px;">
            	...
            	<h2>Shop</h2>
                Details on the shop to follow, please <a href="contact.htm">contact us</a> if you need more information
            </div>
